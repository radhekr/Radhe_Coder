...
<!-- ------------------------------Above this you can insert the card ---------------------------------------    -->
    ...
    <div class="col-md-2 bg-secondary p-0">
        <ul class="navbar-nav me-auto text-center">
            ...
            <li class="nav-item ">
                <a href="#" class="nav-link text-light"><h5> Brands-2</h5></a>
            </li>


            <li class="nav-item ">
                <a href="#" class="nav-link text-light"><h5> Brands-3</h5></a>
            </li>


            <li class="nav-item ">
                <a href="#" class="nav-link text-light"><h5> Brands-4</h5></a>
            </li>


            <li class="nav-item ">
                <a href="#" class="nav-link text-light"><h5> Brands-5</h5></a>
            </li>
