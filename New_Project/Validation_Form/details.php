                ...
                <table class="table">
                    ...
                    <?php
                        // <!-- id	name	fname	email	mobno	gender	date	course	yf	yt	address	 -->
                         ...
                         $sqll = "SELECT p1_form.*, emp.salary, emp.job FROM p1_form, emp WHERE p1_form.id=emp.id ORDER BY p1_form.name;";
                        //  $sqll = "SELECT * FROM p1_form";
                        //  $sqll = "SELECT p1_form.*, emp.salary, emp.job FROM p1_form, emp WHERE p1_form.name=emp.name ORDER BY p1_form=name";
