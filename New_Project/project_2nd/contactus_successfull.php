...
<body>
    ...
    <div class="alert alert-success m-5 p-5 text-center" role="alert">
        ...
        <p>Your query has been successfully send. I will try our best to reply you as soon as possible.</p>
        <hr>
        <p class="mb-0">Thanks for visit my online services portal!</p>
    </div>
    <div class="text-center m-4">
        <a href="index.php"><button class="btn btn-primary fs-4">Go to home page</button></a>
    </div>
