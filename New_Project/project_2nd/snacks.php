            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active" href="snacks.php" id="navbarDropdownMenuLink"
    ...
    <div class="album py-5 bg-light">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                ...
                <div class="col">
                    <div class="card shadow-sm m-4">
                        <img src="image/samosa.jpg" alt="rasgulla image" class="productImg" />

                        <div class="card-body">
                            <div class="card mb-4 box-shadow">
                                <div class="card-header">
                                    <h4 class="my-0 font-weight-normal fw-bold text-normal text-center">Samosa</h4>
                                </div>
                                <h5 class="card-title pricing-card-title fst-italic text-center my-2">Rs. 8 <small
                                        class="text-muted">/-
                                        pcs</small><br />
                                </h5>
                                <small class="mx-auto">3850+ Orders placed from here recently.</small><br />
                                <a href="Buy_form.php" class="mx-auto"><button type="button" class="btn btn-sm btn-block btn-primary">Add to
                                    Cart</button></a>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="card shadow-sm m-4">
                        <img src="image/Momos.jpg" alt="gulab-jamun image" class="productImg" />

                        <div class="card-body">
                            <div class="card mb-4 box-shadow">
                                <div class="card-header">
                                    <h4 class="my-0 font-weight-normal fw-bold text-normal text-center">Momos</h4>
                                </div>
                                <h5 class="card-title pricing-card-title fst-italic text-center my-2">Rs. 10 <small
                                        class="text-muted">/-
                                        pcs</small><br />
                                </h5>
                                <small class="mx-auto">2290+ Orders placed from here recently.</small><br />
                                <a href="Buy_form.php" class="mx-auto"><button type="button" class="btn btn-sm btn-block btn-primary">Add to
                                    Cart</button></a>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="card shadow-sm m-4">
                        <img src="image/SAMOSA-CHAAT.jpg" alt="Rasmalai image" class="productImg" />

                        <div class="card-body">
                            <div class="card mb-4 box-shadow">
                                <div class="card-header">
                                    <h4 class="my-0 font-weight-normal fw-bold text-normal text-center">Samosa Chaat</h4>
                                </div>
                                <h5 class="card-title pricing-card-title fst-italic text-center my-2">Rs. 45 <small
                                        class="text-muted">/-
                                        pcs</small><br />
                                </h5>
                                <small class="mx-auto">3530+ Orders placed from here recently.</small><br />
                                <a href="Buy_form.php" class="mx-auto"><button type="button" class="btn btn-sm btn-block btn-primary">Add to
                                    Cart</button></a>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="card shadow-sm m-4">
                        <img src="image/masaledar-poori.jpg" alt="jalebi image" class="productImg" />

                        <div class="card-body">
                            <div class="card mb-4 box-shadow">
                                <div class="card-header">
                                    <h4 class="my-0 font-weight-normal fw-bold text-normal text-center">Masaledar Poori</h4>
                                </div>
                                <h5 class="card-title pricing-card-title fst-italic text-center my-2">Rs. 30 <small
                                        class="text-muted">/-
                                        plate</small><br />
                                </h5>
                                <small class="mx-auto">3700+ Orders placed from here recently.</small><br />
                                <a href="Buy_form.php" class="mx-auto"><button type="button" class="btn btn-sm btn-block btn-primary">Add to
                                    Cart</button></a>
                            </div>
                        </div>
